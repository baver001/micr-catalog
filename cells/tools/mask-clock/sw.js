const CACHE='micr-mask-clock-v1';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.svg','./icon-512.svg','/data/styles/mascot.css','/data/styles/micr-shell.css','/data/js/mascot.js','/data/js/pwa-install.js','/data/js/micr-shell.js','/data/graph.json','/data/surfaces.json'];
